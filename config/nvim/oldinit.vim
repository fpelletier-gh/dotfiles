...
Plug 'junegunn/vim-github-dashboard'
  let g:github_dashboard = { 'username': 'fpelletier-gh' }
...
" Lint
" Plug 'w0rp/ale'
"   let g:ale_linters = {'jsx': ['css', 'javascript'], 'js': ['css', 'javascript'], 'css': ['css'], 'html': ['html']}
...
nnoremap <leader>e :CocCommand prettier.formatFile<cr>
...
" inoremap <expr> <Enter> pumvisible() ? "\<C-y>"
"
...
" endfunction
 ...
 if has_key(g:plugs, 'coc.nvim')
  ...
  let g:coc_global_extensions = ['coc-github', 'coc-yaml', 'coc-solargraph',
    ...
    \ 'coc-prettier', 'coc-eslint', 'coc-tsserver', 'coc-emoji', 'coc-java', 'coc-emmet']
