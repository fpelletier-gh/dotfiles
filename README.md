...
This is a collection of vim, tmux, and zsh configurations for Javascript web development. Inspired by [Nick Nisi's dotfiles](https://github.com/nicknisi/dotfiles)
...
```bash
➜ git clone https://github.com/fpelletier-gh/dotfiles.git ~/.dotfiles
➜ cd ~/.dotfiles
➜ ./install.sh
```
